        ...
        @if($this->analytics['total_trades'] > 0)
            <div class="grid grid-cols-2 gap-3 sm:grid-cols-4">
                <div class="rounded-xl border border-zinc-200 bg-white p-4 dark:border-zinc-700 dark:bg-zinc-900">
                    ...
                    <p class="mt-1 text-2xl font-bold {{ $this->analytics['win_rate'] >= 50 ? 'text-emerald-600 dark:text-emerald-400' : 'text-red-500' }}">
                ...
                <div class="rounded-xl border border-zinc-200 bg-white p-4 dark:border-zinc-700 dark:bg-zinc-900">
                    ...
                    <p class="mt-1 text-2xl font-bold {{ $this->analytics['total_profit'] >= 0 ? 'text-emerald-600 dark:text-emerald-400' : 'text-red-500' }}">
        ...
        <div class="rounded-xl border border-zinc-200 bg-white dark:border-zinc-700 dark:bg-zinc-900">
            <div class="flex border-b border-zinc-100 dark:border-zinc-800">
                <button
                    ...
                    class="px-5 py-3.5 text-sm font-medium transition-colors {{ $activeTab === 'profit_table' ? 'border-b-2 border-zinc-900 text-zinc-900 dark:border-white dark:text-white' : 'text-zinc-500 hover:text-zinc-700 dark:hover:text-zinc-300' }}"
                >
                    Trades
                </button>
                <button
                    wire:click="switchTab('statement')"
                    class="px-5 py-3.5 text-sm font-medium transition-colors {{ $activeTab === 'statement' ? 'border-b-2 border-zinc-900 text-zinc-900 dark:border-white dark:text-white' : 'text-zinc-500 hover:text-zinc-700 dark:hover:text-zinc-300' }}"
                >
                    Transactions
                </button>
            </div>
                            ...
                            <tbody class="divide-y divide-zinc-100 dark:divide-zinc-800">
                                @foreach($transactions as $trade)
                                    ...
                                    <tr class="hover:bg-zinc-50/50 dark:hover:bg-zinc-800/30">
                                        ...
                                        <td class="px-4 py-3 text-right font-semibold {{ $isWin ? 'text-emerald-600 dark:text-emerald-400' : 'text-red-500' }}">
                            ...
                            <tbody class="divide-y divide-zinc-100 dark:divide-zinc-800">
                                @foreach($transactions as $txn)
                                    ...
                                    <tr class="hover:bg-zinc-50/50 dark:hover:bg-zinc-800/30">
                                        ...
                                        <td class="px-4 py-3 text-right font-semibold {{ $amount >= 0 ? 'text-emerald-600 dark:text-emerald-400' : 'text-red-500' }}">
