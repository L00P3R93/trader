    ...
    public function steps(): array
    {
        return [
            ...
            [
                ...
                'description' => 'Link your Deriv account to get started. You can connect via OAuth2 (one-click sign-in through Deriv\'s website) or paste a Personal Access Token from your Deriv account settings. Either method gives the platform secure access to execute trades on your behalf.',
                ...
                'action_secondary_label' => 'Connect My Account',
                'action_route' => 'account',
            ],
            [
